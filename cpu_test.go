...
csrrwi zero, sepc, 6
csrrci zero, sepc, 0 `
	riscvTest(t, code, "test_csrs1", 20, []TestExp{
		{RegName: "mstatus", Expect: 1},
		{RegName: "mtvec", Expect: 2},
		{RegName: "mepc", Expect: 3},
		{RegName: "sstatus", Expect: 0},
